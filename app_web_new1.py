...
# --- 1. CONFIGURAÇÃO DA PÁGINA (CORRIGIDO PARA MANTER A BARRA LATERAL EXPANDIDA NO CELULAR) ---
st.set_page_config(
    page_title="Sistema OGMO-ES v8.1", 
    layout="wide", 
    page_icon="🚢",
    initial_sidebar_state="expanded"  # Garante que o menu não fique oculto em telas pequenas
)
